...
"""
jishaku.paginators (shim for disnake.py 2.0.0)
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
class PaginatorInterface(ui.View):  # pylint: disable=too-many-instance-attributes
    ...
    async def button_start(self, button: ui.Button, interaction: disnake.Interaction):  # pylint: disable=unused-argument
    ...
    async def button_previous(self, button: ui.Button, interaction: disnake.Interaction):  # pylint: disable=unused-argument
    ...
    async def button_current(self, button: ui.Button, interaction: disnake.Interaction):  # pylint: disable=unused-argument
    ...
    async def button_next(self, button: ui.Button, interaction: disnake.Interaction):  # pylint: disable=unused-argument
    ...
    async def button_last(self, button: ui.Button, interaction: disnake.Interaction):  # pylint: disable=unused-argument
    ...
    async def button_close(self, button: ui.Button, interaction: disnake.Interaction):  # pylint: disable=unused-argument
