...
def run_lavalink_process():
    ...
    if process.returncode == 0:
        logger.success(
            f'The program "{program}" is installed. Lavalink can be run.')  # checking if Java is installed on the host
        # system.
        ...
        logger.error(f'Sorry program {program} is not installed in your system. Please install it in order to run our '
                     f'Jar '
                     f'application.')
